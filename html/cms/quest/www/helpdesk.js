...
function retailer_chk(email_mobile,flag) {
    ...
    try {
        ...
        $.post(url, {
            email: email_mobile
                ...
                function (data) {
			check_retailer(data,flag,email_mobile);
                });
    } catch (e) {
        alert(e);
    }
...
function check_retailer(data,flag,email_mobile)
{
	    var ret_valid;
	    var myObj = JSON.parse(data);
//	    alert("test" + myObj.status+' '+ flag + ' '+ email_mobile);
	    if (myObj.status == "Success")
		        ret_valid = 1;
	    else
		        ret_valid = 2;
...
function check_admin(data,flag,email_mobile)
{
	    var adm_valid;
	    var myObj = JSON.parse(data);
//	    alert("test" + myObj.status+' '+ flag + ' '+ email_mobile);
...
function login_retailer_chk() {
    ...
    if (email_mobile != '')
    {
        if (!isNaN(email_mobile))
        {
            ...
            {
                flag = 1;
                retailer_chk(email_mobile,flag);
