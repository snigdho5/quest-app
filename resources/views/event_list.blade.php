    ...
    <div class="container">
                ...
                <form action="" class="mob_space">
                    <div class="input-group input-group-lg rounded-0">
                      <div class="input-group-prepend">
                        <label class="input-group-text pl-0" for="inputGroupSelect01" style="color: #d0ad68; background: none; border: none;">Filter Events By</label>
                      </div>
        ...
        <div class="row deals_cont" id="deals_cont">
            ...
            <div class="col-sm-12"><h4 class="mt-5 mb-5 text-center text-muted">Sorry! We couldn't find any event.<br><small>Please try again with different preferences.</small></h4>
                ...
                <a href="events/{{ $value->slug }}">
                    <div class="card border-0">
                        ...
                        <div class="d_cont pt-1">
                            <h6 class="mb-0 float-left" style="color: #404041;">{{ $value->start_date->format('dS M, Y') }}</h6>
                            <h6 class="mb-0 float-right" style="color: #404041;">{{ $value->end_date->format('dS M, Y') }}</h6>
                        </div>
