...
<div class="content-wrapper">
  ...
  <section class="content-header">
    <h1>
    Edit Banner of '{{ get_anydata('store',$store_id, 'name') }}'
    </h1>
    <ol class="breadcrumb">
      <li><a href="admin"><i class="fa fa-dashboard"></i> Dashboard</a></li>
      <li><a href="admin/store">Stores</a></li>
      <li><a href="admin/store/{{ $store_id }}/banner">Banner</a></li>
          ...
          {{ csrf_field() }}
            <div class="row">
              <div class="col-sm-2">
                ...
                @if($data->image)
                <img src="{{ asset('storage/store_banner/actual/'.$data->image) }}" alt="..." class="img-responsive">
                @else
                No image found.
                @endif
                <hr>
                <p><b>App Image:</b></p>
                @if($data->app_image)
                <img src="{{ asset('storage/store_banner/app/'.$data->app_image) }}" alt="..." class="img-responsive">
                @else
                No image found.
                @endif
              </div>
              ...
              <div class="col-sm-12">
                <div class="box-footer text-right">
                  <a class="btn btn-primary pull-left waves-effect" href="admin/store/{{ $store_id }}/banner">Back</a>
