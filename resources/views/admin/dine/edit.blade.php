            ...
            <div class="row">
              ...
              <div class="col-sm-10">
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    <select class="form-control" name="floor" required>
                      ...
                      <option  {{ $data->floor=="Sixth Floor" ? 'selected':'' }}>Sixth Floor</option>
                    </select>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                      <select class="form-control" name="cuisine[]" multiple data-placeholder="-- Choose --" required>
                        @foreach($cuisine as $value)
                            <option value="{{ $value->id }}" {{ in_array($value->id ,explode(',',$data->cuisine)) ? 'selected':'' }}>{{ $value->title }}</option>
                        @endforeach
                      </select>
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-10">
                      <input type="text" class="form-control" placeholder="Enter menu" name="menu" value="{{ $data->menu }}">
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-10">
                      <input type="text" class="form-control" placeholder="Enter review" name="review" value="{{ $data->review }}">
                    ...
                    @if($data->contactno->count()>0)
                      ...
                      <div class="input-group">
                        <span class="input-group-addon">
                          ...
                          <input type="text" class="form-control" placeholder="Enter dine phone number" name="store_phones[]" required value="{{$value->phone}}">
                    ...
                    @if($data->contactemail->count()>0)
                      ...
                      <div class="input-group">
                        <span class="input-group-addon">
                          ...
                          <input type="text" class="form-control" placeholder="Enter dine email" name="emails[]" required value="{{$value->email}}">
              ...
              <div class="col-sm-12">
                <div class="box-footer text-right">
                  <a class="btn btn-primary pull-left waves-effect" href="admin/dine/">Back</a>
