...
<div class="content-wrapper">
  ...
  <section class="content-header">
    ...
    <ol class="breadcrumb">
      ...
      <li><a href="admin/cms/">Custom Page</a></li>
    ...
    <div class="box">
      <form class="form-horizontal" action="" method="post" enctype="multipart/form-data">
        ...
        <div class="box-footer text-right">
          <a class="btn btn-primary pull-left" href="admin/cms/">Back</a>
...
<script>
  ...
  function headerToggle(yes) {
    if(yes == 1){
      $('[name="imagefile"]').prop('required', true).closest('.form-group').show()
    }else{
      $('[name="imagefile"]').prop('required', false).closest('.form-group').hide()
    }
  }
</script>
