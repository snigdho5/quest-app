...
<div class="content-wrapper">
  ...
  <section class="content-header">
    ...
    <ol class="breadcrumb">
      ...
      <li class="active">Website Navigation</li>
    </ol>
  </section>
  <!-- Main content -->
    ...
    <div class="box">
      <div class="box-header">
        <h3 class="box-title" style="display:block">Navigation List
          ...
          <a class="btn btn-primary btn-sm pull-right" href="admin/navigation/create/">Add New</a></h3>
          @endif
      </div>
      <div class="box-body">
          ...
          <tbody>
            ...
            <tr>
              ...
              <td>{{ $value->active=='0'?'No':'Yes' }}
                ...
                <a href="admin/navigation/status/{{ $value->id }}/{{ $value->active=='0'?'1':'0' }}"><i class="fa fa-refresh fa-fw"></i></a>
                @endif
              </td>
              <td class="text-right">
                @if(in_array('edit',$access_type))
                <a title="Edit" class="btn btn-success btn-xs" href="admin/navigation/edit/{{ $value->id }}"><i class="fa fa-pencil fa-fw"></i></a>
                @endif
                @if(in_array('delete',$access_type))
                <a title="Delete" class="btn btn-danger btn-xs" onclick="return confirm('Once deleted it cannot be restored. Are you sure you want to delete this?')" href="admin/navigation/delete/{{ $value->id }}"><i class="fa fa-close fa-fw"></i></a>
                @endif
              </td>
            </tr>
            @endforeach
