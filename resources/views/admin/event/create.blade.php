    ...
    <div class="box">
      <form class="form-horizontal" action="" method="post" enctype="multipart/form-data">
        ...
        <div class="box-body">
          ...
          <div class="form-group" id="loft" style="display: none">
            ...
            <div class="col-sm-10">
              <select class="form-control" name="designers[]" multiple data-placeholder="-- Choose --">
                ...
                <option value="{{ $value['id'] }}" {{ in_array($value['id'],old('designers',[]))?'selected':'' }}>{{ $value['name'] }}</option>
                @endforeach
              </select>
        ...
        <div class="box-footer text-right">
          <a class="btn btn-primary pull-left" href="admin/event/">Back</a>
