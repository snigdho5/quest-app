      ...
      <form class="form-horizontal" action="" method="post" enctype="multipart/form-data">
        ...
        <div class="box-body">
          ...
          <div class="form-group">
            ...
            <div class="col-sm-10">
              <textarea class="form-control" placeholder="Enter offer" name="offer" required>{{ old('offer') }}</textarea>
          ...
          <div class="form-group">
            ...
            <div class="col-sm-10">
              <select class="form-control" name="threshold" required>
                ...
                <option value="{{ $value->id }}" {{ old('threshold') == $value->id ?'selected':'' }}>{{ $value->type }} ({{ $value->threshold }} Steps)</option>
                @endforeach
              </select>
          ...
          <div class="form-group">
            ...
            <div class="col-sm-10">
              <input type="text" class="form-control" autocomplete="off" placeholder="Enter start date" name="start_date" value="{{ old('start_date') }}">
          ...
          <div class="form-group">
            ...
            <div class="col-sm-10">
              <div class="input-group">
                <input type="number" min="1" max="30" class="form-control" required placeholder="Enter day" name="redeem_within" value="{{ old('redeem_within') }}">
          ...
          <div class="form-group">
            ...
            <div class="col-sm-10">
              <div class="input-group">
                <input type="text" maxlength="10" class="form-control" required placeholder="Enter redeem code" name="code" value="{{ old('code') }}">
