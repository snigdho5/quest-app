...
<div class="content-wrapper">
  ...
  <section class="content-header">
    ...
    <ol class="breadcrumb">
      ...
      <li><a href="admin/app_navigation/">App navigation</a></li>
            ...
            <div class="row">
              <div class="col-sm-12">
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    <input type="text" class="form-control" placeholder="Enter icon" name="icon" required value="{{ $data->icon }}">
                    @if($errors->first('icon')) <p class="text-danger">{{ $errors->first('icon') }}</p> @endif
                  </div>
                </div>
                <div class="form-group">
                  <label class="control-label col-sm-2">App Page</label>
                  <div class="col-sm-10">
                    <select class="form-control" name="page" required onchange="pageDetails(this.value)">
                      ...
                      <option value="entrybooking" {{ $data->page=='entrybooking'?'selected':'' }}>Entry Booking</option>
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    <select class="form-control" name="new" required>
                      ...
                      <option value="1" {{ $data->new=='1'?'selected':'' }}>Yes</option>
                      <option value="0" {{ $data->new=='0'?'selected':'' }}>No</option>
                    </select>
                    @if($errors->first('new')) <p class="text-danger">{{ $errors->first('new') }}</p> @endif
                  </div>
                </div>
                <div class="form-group">
              ...
              <div class="col-sm-12">
                <div class="box-footer text-right">
                  <a class="btn btn-primary pull-left waves-effect" href="admin/app_navigation/">Back</a>
