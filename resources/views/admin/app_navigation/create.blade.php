    ...
    <div class="box">
      ...
      <form class="form-horizontal" action="" method="post" enctype="multipart/form-data">
        ...
        <div class="box-body">
          <div class="form-group">
           ...
           <div class="form-group">
            ...
            <div class="col-sm-10">
              <input type="text" class="form-control" placeholder="Enter icon" name="icon" required value="{{ old('icon') }}">
          ...
          <div class="form-group">
            ...
            <div class="col-sm-10">
              <select class="form-control" name="page" required onchange="pageDetails(this.value)">
                ...
                <option value="entrybooking">Entry Booking</option>
        ...
        <div class="box-footer text-right">
          ...
          <a class="btn btn-primary pull-left" href="admin/app_navigation/">Back</a>
