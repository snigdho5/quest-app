        ...
        <div class="row">
            <div class="col-md-12 text-center">
                <div class="event_details pt-lg-5 pt-4 pb-3">
                    <h1 style="color: #6e2842;">{{ $eventData->title }}</h1>
                ...
                <div class="gallery mb-lg-5 mb-4">
                    <div class="container">
                                ...
                                <div class="row justify-content-center">
                                    ...
                                    <div class="col-md-3 col-6 gallery-grids-left-subr mb-4">
                                        <div class="gallery-grid ">
                                            <a class="example-image-link fresco d-block" href="{{ asset('storage/event_gallery/actual/'.$value->image) }}" data-fresco-group="gallery"  data-fresco-group-options="ui: 'inside', onShow: showFrescoHandler" data-fresco-caption="{{ $value->title }}">
            ...
            <div class="col-12 mb-4">
                ...
                <div class="owl-carousel owl-theme articleslider mt-lg-4 mt-3" id="rightarrow">
                    ...
                    <div class="item border-right">
                        <a class="media" href="the-loft/events/{{ $value->slug }}" style="text-decoration: none">
